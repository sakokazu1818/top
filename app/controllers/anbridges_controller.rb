  ...
  def set_contents
    @contents = [
      { ja: 'COMPANY', es: 'COMPANY PROFILE', img: 'company_profile.jpg',
        ...
        text: ['企業と人材の“生の声”を繋ぐ架け橋になる為、「人が好き」という想いを形にホスピタリティに磨きをかけ、関わる全ての人に寄り添います。'] },
